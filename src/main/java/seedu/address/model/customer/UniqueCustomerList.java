 ...
 * customers uses Customer#isSameCustomer(Customer) for equality so as to
 * ensure that the customer being added or updated is
 * unique in terms of identity in the UniqueCustomerList. However,
 * the removal of a customer uses Customer#equals(Object) so
